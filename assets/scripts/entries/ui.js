...
const onDeleteEntrySuccess = entryData => {
  $('.delete-message').text('Successfully deleted entry!').fadeOut(3000)
}

const onDeleteEntryFailure = responseData => {
  $('.delete-message').text('Could not delete entry. Please try again').fadeOut(3000)
}
